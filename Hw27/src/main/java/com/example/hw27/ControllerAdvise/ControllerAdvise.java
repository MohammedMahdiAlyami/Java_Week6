package com.example.hw27.ControllerAdvise;

import com.example.hw27.ApiException.ApiException;
import com.example.hw27.ApiResponse.ApiResponse;
...
public class ControllerAdvise {
    ...
    public ResponseEntity<ApiResponse> TransactionSystemException(TransactionSystemException e){
        String massage= e.getMessage();
        return ResponseEntity.status(400).body(new ApiResponse(massage+"Prescription not assigned to patien"));
    }
